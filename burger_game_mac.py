...
class StartPage(object):  # 開始畫面
    ...
    def createPage(self):
        ...
        f1 = tkFont.Font(size = 36, family = "翩翩体-简")
        f2 = tkFont.Font(size = 18, family = "翩翩体-简")
        f3 = tkFont.Font(size = 14, family = "翩翩体-简")
        # 底下的grid
...
class RankingPage1(object):  # 現在是成就榜(前)
    ...
    def createPage(self):
        ...
        f1 = tkFont.Font(size = 36, family = "翩翩体-简", weight = "bold")
        f2 = tkFont.Font(size = 18, family = "翩翩体-简")
        f3 = tkFont.Font(size = 14, family = "翩翩体-简")
...
class IntroPage(object):  # 輸入姓名頁面
    ...
    def createPage(self):
        ...
        f1 = tkFont.Font(size = 18, family = "翩翩体-简")
        f2 = tkFont.Font(size = 14, family = "翩翩体-简")
        f3 = tkFont.Font(size = 12, family = "翩翩体-简")
...
class RulePage(object):  # 營業說明
    ...
    def createPage(self):
        ...
        f2 = tkFont.Font(size = 18, family = "翩翩体-简")
        f3 = tkFont.Font(size = 14, family = "翩翩体-简")
        f4 = tkFont.Font(size = 14, family = "翩翩体-简")
        ...
        style.configure("Treeview", rowheight = 38, font = ("翩翩体-简", 14))
...
class KnowledgePage(object):  # Day 1 小知識的日子
    ...
    def createPage(self):
        ...
        f1 = tkFont.Font(size = 28, family = "翩翩体-简")
        f2 = tkFont.Font(size = 14, family = "翩翩体-简")
        f3 = tkFont.Font(size = 12, family = "翩翩体-简")
...
class CorrectPage(object):  # Day 1 答對頁面
    ...
    def createPage(self):
        ...
        # 下一頁按鈕
        Button(self.page, text = '繼續遊戲', width = 10, height = 2, font = f3, bg = 'Lavender',
...
class WrongPage(object):  # Day 1 答錯頁面
    ...
    def createPage(self):
        ...
        f1 = tkFont.Font(size = 30, family = "翩翩体-简")
        f2 = tkFont.Font(size = 14, family = "翩翩体-简")
        f3 = tkFont.Font(size = 12, family = "翩翩体-简")
...
class EverydayPage(object):  # 每日漢堡製作畫面
    ...
    def createPage(self):
        ...
        f2 = tkFont.Font(size = 18, family = "翩翩体-简")
        f3 = tkFont.Font(size = 12, family = "翩翩体-简")
        f4 = tkFont.Font(size = 20, family = "翩翩体-简")
        ...
        self.page.lbl_description1 = tk.Label(self.page, text = "餐廳開始營業囉，", height = 1, width = 15, bg = '#f9f7f1',
                                              fg = "#666666", font = f2)
        self.page.lbl_description1.place(x = 360, y = 240)
        self.page.lbl_description2 = tk.Label(self.page, text = "點選繼續遊戲查看你今天的營業成果吧~", height = 1, width = 30,
                                              bg = '#f9f7f1', fg = "#666666", font = f2)
        self.page.lbl_description2.place(x = 270, y = 290)
...
class EverydayResultPage(object):  # 每日結算畫面
    ...
    def createPage(self):
        ...
        if counts == 0 or counts == 3:
            # 下一頁按鈕
            Button(self.page, text = '知識問答', width = 10, height = 2, font = f3,bg = 'Lavender',
...
class FirstdayStockPage(object):  # Day1 訂貨畫面 (教學訂購)
    ...
    def createPage(self):
        ...
        f2 = tkFont.Font(size = 14, family = "翩翩体-简")
        f3 = tkFont.Font(size = 12, family = "翩翩体-简")
        f4 = tkFont.Font(size = 10, family = "翩翩体-简")
        ...
        if counts != 2 and counts < 6:
            # 訂購按鈕
            Button(self.page, text = '訂購!', width = 10, height = 2, font = f3, bg = 'Lavender',
...
class EverydayStockPage(object):  # Day2~Day7 訂貨畫面 (玩家自行訂購)
    ...
    def createPage(self):
        ...
        f1 = tkFont.Font(size = 30, family = "翩翩体-简")
        f2 = tkFont.Font(size = 23, family = "翩翩体-简")
        f3 = tkFont.Font(size = 12, family = "翩翩体-简")
        f4 = tkFont.Font(size = 14, family = "翩翩体-简")
...
class FinalResultPage1(object):
    ...
    def createPage(self):
        ...
        f1 = tkFont.Font(size = 26, family = "翩翩体-简")
        f2 = tkFont.Font(size = 14, family = "翩翩体-简")
        f3 = tkFont.Font(size = 12, family = "翩翩体-简")
...
class FinalResultPage2(object):
    ...
    def createPage(self):
        ...
        f1 = tkFont.Font(size = 28, family = "翩翩体-简", weight = "bold")
        f2 = tkFont.Font(size = 14, family = "翩翩体-简")
        f3 = tkFont.Font(size = 12, family = "翩翩体-简")
